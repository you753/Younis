    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">إدارة المبيعات</h3>
          <p className="text-gray-600 mb-6">سيتم تطوير نظام إدارة المبيعات والفواتير قريباً</p>
