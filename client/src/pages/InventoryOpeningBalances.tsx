          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-700">{totalQuantity.toLocaleString('ar-SA')}</p>
              </div>
              ...
              <TableBody>
                {filteredBalances.map((balance) => (
                  <TableRow key={balance.id}>
                    ...
                    <TableCell>{parseFloat(balance.openingQuantity || '0').toLocaleString('ar-SA')}</TableCell>
                    <TableCell>
                      {parseFloat(balance.unitCost || '0').toLocaleString('ar-SA', { style: 'currency', currency: 'SAR' })}
                    </TableCell>
                    <TableCell className="font-bold">
                      {parseFloat(balance.openingValue || '0').toLocaleString('ar-SA', { style: 'currency', currency: 'SAR' })}
                    </TableCell>
                    <TableCell>{balance.location || '-'}</TableCell>
                    <TableCell>{new Date(balance.dateRecorded).toLocaleDateString('ar-SA')}</TableCell>
                    <TableCell>
                      <div className="flex gap-2">
                        <Button
                          variant="outline"
              ...
              {form.watch('openingQuantity') && form.watch('unitCost') && (
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-blue-800 dark:text-blue-200">
                    {(parseFloat(form.watch('openingQuantity') || '0') * parseFloat(form.watch('unitCost') || '0')).toLocaleString('ar-SA', { 
                      style: 'currency', 
                      currency: 'SAR' 
                    })}
                  </p>
