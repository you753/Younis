...
const FastProducts = () => (
  <div className="p-4">
    ...
    <div className="text-center py-8">
      ...
      <p className="text-gray-600">محتوى المنتجات سيتم تحميله هنا</p>
    </div>
  </div>
);
...
const FastReports = () => (
  <div className="p-4">
    ...
    <div className="text-center py-8">
      ...
      <p className="text-gray-600">محتوى التقارير سيتم تحميله هنا</p>
    </div>
  </div>
);
      ...
      <div className="flex-1 overflow-hidden">
        ...
        <main className="overflow-auto h-[calc(100vh-3.5rem)]">
          <Router base={`/branch-app/${branchId}`}>
            ...
            <Route path="/reports" component={FastReports} />
