                      ...
                      <SelectContent>
                        {clients.map((client) => (
                          <SelectItem key={client.id} value={client.id.toString()}>
                            {client.name} - الرصيد: {parseFloat(client.balance || '0').toLocaleString('ar-SA', { style: 'currency', currency: 'SAR' })}
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium mr-2">
                      {parseFloat(selectedClient.balance || '0').toLocaleString('ar-SA', { 
                        style: 'currency', 
                        currency: 'SAR' 
                      })}
                    </span>
